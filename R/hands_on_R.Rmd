...
fitness based on 179 species, 167 studies, and 1640 effect sizes 55. To
address the statistical dependence among effect sizes (with 10 effect
sizes per study), the original publication employed Bayesian multilevel
meta-analytic modelling with phylogenetic relatedness, study, and
observation identities as random effects.
